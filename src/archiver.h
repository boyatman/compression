...
class Archiver {
  enum class ARCHIVER_RETURN_CODE {
    SUCCESSFUL = 1, INPUT_FILE_NOT_FOUND, OUTPUT_FILE_ALREADY_EXISTS
  };
...
private:
  ...
  void ProcessSegment(std::size_t index, const std::bitset<10>& bitset, const std::vector<std::string>& row, std::vector<
